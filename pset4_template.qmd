...
pos2016_df = pd.read_csv(os.path.join(ben_path, pos2016))
...
pos2017_df = pd.read_csv(os.path.join(ben_path, pos2017))
...
pos2018_df = pd.read_csv(os.path.join(ben_path, pos2018), encoding="ISO-8859-1")
...
pos2019_df = pd.read_csv(os.path.join(ben_path, pos2019), encoding="ISO-8859-1")
...
shp = gpd.read_file(ben_shp_path)
```
...
print(time_test)
```
Given that this took .35 seconds and there are 1935 zips in zips_texas_centoids, I expect the entire operation to take abot 68 seconds.
    b.
```{python}
start2 = time.time()
